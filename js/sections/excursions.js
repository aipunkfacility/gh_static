        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ${activeExcursions.map(excursion => {
            ...
            const imageHtml = excursion.image 
              ? `<div class="h-56 overflow-hidden group flex-shrink-0 relative">
                   <img src="${excursion.image}" alt="${escapeHTML(title)}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy">
