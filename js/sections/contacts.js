    ...
    <section id="contacts" class="py-16 bg-white">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="bg-blue-50 rounded-lg p-8 text-center">
          ...
          <button onclick="openWhatsApp()" class="bg-green-500 text-white px-8 py-4 rounded-lg font-bold hover:bg-green-600 transition">
            <i class="ri-whatsapp-line mr-2 align-bottom"></i>Написать в WhatsApp
          </button>
        </div>
      </div>
    </section>
