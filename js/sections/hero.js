    ...
    <section id="hero" class="bg-gradient-to-r from-primary to-orange-600 text-white py-20 px-4 text-center">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#excursions" 
             class="bg-white text-primary px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition inline-block">
            Выбрать экскурсию
          </a>
          <a href="#transport" 
             class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-primary transition inline-block">
            Арендовать байк
          </a>
        </div>
      </div>
