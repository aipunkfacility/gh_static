function HeroSection(siteMeta) {
  return `
    ...
    -->
    <section id="hero" class="relative text-white pt-332 pb-328 px-4 text-center flex flex-col justify-between items-center overflow-hidden" style="min-height: 70vh;">
