...
export function validateItem(item, requiredFields) {
...
export function validateExcursion(excursion) {
...
export function validateAccommodation(acc) {
...
export function filterValidActive(items, validator) {
 ...
 */
export function toggleServiceAccordion(element) {
