import { filterValidActive, validateAccommodation } from '../utils.js';
import { renderCardAccommodation } from '../components/cards.js';

export function AccommodationSection(accommodations) {
